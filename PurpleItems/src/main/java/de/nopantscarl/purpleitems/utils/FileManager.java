package de.nopantscarl.purpleitems.utils;
...
public class FileManager {
    ...
    public void setConfigDefaults() {
        ...
        this.cfg.addDefault("messages.giveItemHelp", "&c/purpleitems giveitem <Player> <TurtleHelmet | TurtleChestplate | TurtleLeggings | TurtleBoots | LazyAxe | LazyPickAxe | CobbleVacc | StoneVacc>");
        ...
        this.cfg.addDefault("config.turtlehelmet.loreLine2", "&7breathing if you wear it with the rest of the turtle hermit set. for a faster fishing");
        this.cfg.addDefault("config.turtlehelmet.loreLine3", "&7speed and see clearly in the dark..");

        this.cfg.addDefault("config.turtlechestplate.displayname", "&9Turtle Hermit Chestplate");
        this.cfg.addDefault("config.turtlechestplate.loreLine1", "&7Wear it with the rest of the turtle set for a faster fishing");
        this.cfg.addDefault("config.turtlechestplate.loreLine2", "&7speed and see clearly in the dark..");

        this.cfg.addDefault("config.turtleleggings.displayname", "&9Turtle Hermit Leggings");
        this.cfg.addDefault("config.turtleleggings.loreLine1", "&7Wear it with the rest of the turtle set for a faster fishing");
        this.cfg.addDefault("config.turtleleggings.loreLine2", "&7speed and see clearly in the dark..");

        this.cfg.addDefault("config.turtleboots.displayname", "&9Turtle Hermit Boots");
        this.cfg.addDefault("config.turtleboots.loreLine1", "&7Wear it with the rest of the turtle set for a faster fishing");
        this.cfg.addDefault("config.turtleboots.loreLine2", "&7speed and see clearly in the dark..");
        ...
        for (String vacc : new String[]{
            ...
            String vaccName = vacc.toLowerCase().replaceAll(" +", "") + "vacc";

            this.cfg.addDefault("config." + vaccName + ".displayname", "&8" + vacc + " Vaccine");
            this.cfg.addDefault("config." + vaccName + ".loreLine1", "&7If you have this item in your inventory");
            this.cfg.addDefault("config." + vaccName + ".loreLine2", "&7you can't pickup " + vacc.toLowerCase() + " anymore.");
        }
